...
@register_node(
    type="chebyshev_background",
    category="transform",
    name="Chebyshev Background",
    description="Fit and subtract background using Chebyshev polynomials",
    ...
    config_schema={
        ...
        "properties": {
            "n_terms": {
                ...
                "minimum": 1,
                "maximum": 20,
                "description": "Number of Chebyshev polynomial terms",
            },
            "q_fit_min": {
                "type": "number",
                "description": "Minimum Q for fitting (optional, uses data min if not specified)",
            },
            "q_fit_max": {
                "type": "number",
                "description": "Maximum Q for fitting (optional, uses data max if not specified)",
            },
            "clip_negative": {
                "type": "boolean",
                "default": True,
                "description": "Set negative values to zero after subtraction",
            },
            "return_backgrounds": {
                "type": "boolean",
                "default": False,
                "description": "Store fitted backgrounds in execution context",
            },
        },
    },
)
