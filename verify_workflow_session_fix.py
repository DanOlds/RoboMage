...
async def verify_fix():
    ...
    try:
        ...
        print(f"   ❌ Cannot connect to workflow service on port 8002")
        print(f"   Error: {e}")
        print()
    ...
    async with httpx.AsyncClient(timeout=30.0) as client:
        try:
            ...
            if exec_result["status"] != "completed":
                print(f"   ❌ Workflow failed: {exec_result.get('error', 'Unknown error')}")
                return
    ...
    print(f"   ✅ Full DiffractionData found!")
    ...
    try:
        ...
        print(f"   ✅ DiffractionData reconstruction successful!")
