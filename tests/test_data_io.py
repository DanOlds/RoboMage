...
from robomage.data_io import load_chi_file, get_data_info, load_test_data
...
def test_get_data_info():
    ...
    expected_keys = {'num_points', 'q_range', 'q_step_mean', 'q_step_std', 
                    'intensity_range', 'intensity_mean', 'intensity_std'}
